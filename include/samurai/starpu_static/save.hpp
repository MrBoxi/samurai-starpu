...
#error "The header file <samurai/starpu_static/save.hpp> should not be included if SAMURAI_WITH_STARPU is not defined."
#endif
...
namespace samurai::starpu_static
{
